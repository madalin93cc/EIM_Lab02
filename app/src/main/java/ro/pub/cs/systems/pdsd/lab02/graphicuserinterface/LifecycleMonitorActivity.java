...
public class LifecycleMonitorActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
		...
		if (savedInstanceState != null) {
			...
			EditText editText1 = (EditText)findViewById(R.id.password_edit_text);
			EditText editText2 = (EditText)findViewById(R.id.username_edit_text);
			editText1.setText(savedInstanceState.getString(Constants.PASSWORD_EDIT_TEXT));
			editText2.setText(savedInstanceState.getString(Constants.USERNAME_EDIT_TEXT));
		}
		else {
	...
	protected void onStart() {
		super.onStart();
		Log.d(Constants.TAG, "On start");
	}

	@Override
	protected void onRestart() {
		super.onRestart();
		Log.d(Constants.TAG, "On restart");
	}
	...
	protected void onSaveInstanceState(Bundle outState) {
		...
		if (checkbox.isChecked()) {
			EditText editText1 = (EditText)findViewById(R.id.password_edit_text);
			EditText editText2 = (EditText)findViewById(R.id.username_edit_text);
			outState.putString(Constants.PASSWORD_EDIT_TEXT, editText1.getText().toString());
			outState.putString(Constants.USERNAME_EDIT_TEXT, editText2.getText().toString());
		}
	}
}
